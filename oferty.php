...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="styleOferty.css">
    ...
    <div class="lista">';
        while ($row = mysql_fetch_array($produkty))
        {
	       echo '
                ...
                <ul class="list-group">
                <li class="list-group-item">'. strtoupper($row[1]).'</li>
                </ul>
                </div>
                
                <div class="col-md-5 col-md-offset-1">
                <ul class="list-group">
                <li class="list-group-item">'.strtoupper($row[2]).'</li>
                </ul>
                </div>
